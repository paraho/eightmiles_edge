package com.paige.service.apigateway.util.camflake;
...
public interface MachineId {
     ...
     * This method throws {@link CamflakeException} if the implementation of this method failed to response or generate machine ID.
     *
     * @return Machine ID.
     * @throws CamflakeException If failed to response or generate machine ID.
     */
    int getId();
}
