...
@Slf4j
public class CulogHandler extends ApiServiceHandler {

    public CulogHandler(final ApiServiceConfig serviceConfig
                        , final ApiServiceBuilder serviceBuilder
                        , final ErrorHandler errorHandler) {

        super(serviceConfig, errorHandler, serviceBuilder);
        this.contentService.setBaseUrl(serviceConfig.getCulog().getBaseurl());
    }
}
